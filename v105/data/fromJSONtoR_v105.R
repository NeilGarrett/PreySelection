...
# Set output paths  
outCSV_data <- c('/Users/neil/Dropbox/Daw_Lab/PreySelection/v105/data/trialdata_105_processed.csv')
outCSV_stats <- c('/Users/neil/Dropbox/Daw_Lab/PreySelection/v105/data/subdata_105.csv')

# Load data (this is the output of download_datafiles)
datDump = read.csv('/Users/neil/Dropbox/Daw_Lab/PreySelection/v105/data/trialdata_105_raw.csv', header = TRUE)
