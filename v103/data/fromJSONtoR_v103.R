...
# Set output paths  
outCSV_data <- c('/Users/neil/Dropbox/Daw_Lab/PreySelection/v103/data/newpipeline/trialdata_103_processed.csv')
outCSV_stats <- c('/Users/neil/Dropbox/Daw_Lab/PreySelection/v103/data/newpipeline/subdata_103.csv')

# Load data (this is the output of download_datafiles)
datDump = read.csv('/Users/neil/Dropbox/Daw_Lab/PreySelection/v103/data/newpipeline/trialdata_103_raw.csv', header = TRUE)
