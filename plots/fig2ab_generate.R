...
data_A$rank = revalue(data_A$rank, c("percent_accept_A1"="best", "percent_accept_A2"="LRLD", "percent_accept_A3"="HRHD", "percent_accept_A2_A3"="intermediate", "percent_accept_A4"="worst"))
...
#rename them to best, intermediate, worst
data_B$rank = revalue(data_B$rank, c("percent_accept_B1"="best", "percent_accept_B2"="LRLD", "percent_accept_B3"="HRHD", "percent_accept_B2_B3"="intermediate", "percent_accept_B4"="worst"))
...
if (exp==1){
  title_text = "Between Block Effects: Experiment 1"
} else if (exp==2){
  title_text = "Between Block Effects: Experiment 2"
}
